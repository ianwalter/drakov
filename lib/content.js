...
function getBodyContent (body, parseToJson) {
...
exports.matchesBody = function (req, spec) {
  ...
  const reqBody = getBodyContent(req.body, isJson(contentType))
  const specBody = getBodyContent(spec.body, isJson(contentType))
  const bodies = reqBody && specBody

  let isMatch = reqBody === specBody
  if (!isMatch && bodies && typeof reqBody === 'object' && typeof specBody === 'object') {
...
exports.matchesSchema = function (req, spec) {
  ...
  var reqBody = getBodyContent(req.body, isJson(contentType))
